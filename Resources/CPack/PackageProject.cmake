...
elseif("${SIMPLViewProj_RELEASE_TYPE}" STREQUAL "Beta")
  set(SIMPLViewProj_VERSION_SHORT "${SIMPLViewProj_VERSION_MAJOR}.${SIMPLViewProj_VERSION_MINOR}-${SIMPLViewProj_RELEASE_TYPE}-${SIMPLViewProj_VERSION_TWEAK}")
elseif("${SIMPLViewProj_RELEASE_TYPE}" STREQUAL "Development")
  set(SIMPLViewProj_VERSION_SHORT "${SIMPLViewProj_VERSION_MAJOR}.${SIMPLViewProj_VERSION_MINOR}.${SIMPLViewProj_VERSION_PATCH}.${SIMPLViewProj_VERSION_TWEAK}")
else()
  set(SIMPLViewProj_VERSION_SHORT "0.0.0")
endif()


message(STATUS "SIMPLViewProj_VERSION_SHORT: ${SIMPLViewProj_VERSION_SHORT}")


SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "SIMPL View")
SET(CPACK_PACKAGE_VENDOR "BlueQuartz Software, LLC")
#SET(CPACK_PACKAGE_DESCRIPTION_FILE "${PROJECT_BINARY_DIR}/ReadMe-SIMPLView.md")
SET(CPACK_RESOURCE_FILE_LICENSE "${PROJECT_RESOURCES_DIR}/SIMPLView/SIMPLViewLicense.txt")
SET(CPACK_PACKAGE_VERSION_MAJOR ${SIMPLViewProj_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${SIMPLViewProj_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${SIMPLViewProj_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${SIMPLViewProj_VERSION})
...
if(APPLE)
    set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-OSX")
...
elseif(WIN32)
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-Win64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-Win32")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    else()
        set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-Unknown")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    endif()
else()
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-${SIMPLViewProj_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-${SIMPLViewProj_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
        set(CPACK_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-${CMAKE_SYSTEM_NAME}")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    endif()
endif()


set(SIMPLViewProj_WEBSITE_SERVER "thor.bluequartz.net")
set(SIMPLViewProj_WEBSITE_SERVER_PATH "/var/www/dream3d-wp.bluequartz.net")
set(SIMPLViewProj_WEBSITE_SCP_USERNAME "mjackson")
...
if(WIN32 AND NOT UNIX)
  ...
  SET(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "SIMPLView Software Tools")
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "SIMPLView-${SIMPLViewProj_VERSION_SHORT}-Source")
