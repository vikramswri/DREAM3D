...
if (WIN32 AND MSVC)
  ...
  elseif(MSVC_VERSION EQUAL 1910) #Visual Studio 2017 uses same libs as 2015
    set(COMPILER_PREFIX "vc14")
  elseif(MSVC_VERSION EQUAL 1912) # Visual Studio 2017 uses same libs as 2015
    set(COMPILER_PREFIX "vc14")
...
foreach (dir IN LISTS TBB_PREFIX_PATH)
  foreach (prefix IN LISTS COMPILER_PREFIX)
    if (CMAKE_SIZEOF_VOID_P EQUAL 8)
      ...
      list(APPEND TBB_LIB_SEARCH_PATH ${dir}/lib/${TBB_ARCH_TYPE})
      list(APPEND TBB_LIB_SEARCH_PATH ${dir}/lib/${TBB_ARCH_TYPE}/${prefix})
      list(APPEND TBB_LIB_SEARCH_PATH ${dir}/${TBB_ARCH_TYPE}/lib)
      list(APPEND TBB_LIB_SEARCH_PATH ${dir}/${TBB_ARCH_TYPE}/${prefix}/lib)
    else ()
