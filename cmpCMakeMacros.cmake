...
macro(cmp_InstallationSupport EXE_NAME EXE_DEBUG_EXTENSION EXE_BINARY_DIR 
                                appNeedsPlugins installFiles comp dest 
                                lib_search_dirs plugin_list_files)
...
if (0)
    ...
    if ( ${installFiles} EQUAL 1 )
        ...
        # --------------------------------------------------------------------
        # Create a list of all the plugins that are needed in the project including
        # our own and those from Qt possibly. This file list is passed into the 
        # macro through the "pluing_list_files" argument.
        set (PLUGIN_LIST "")
        if ( ${appNeedsPlugins} EQUAL 1)
            foreach(f ${plugin_list_files})
                file(READ ${f} plugin_list)
                LIST (APPEND PLUGIN_LIST ${plugin_list})
            endforeach(f ${plugin_list_files})
        endif()
